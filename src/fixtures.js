export const normalizedComments = [
    ...
    },
    {
        "id": 1,
        "user": "Dolly Franklin",
        "text": "I did not know that's even possible"
    },
    {
        "id": 2,
        "user": "Brennan Atkins",
        "text": "The Empire did nothing wrong!"
    },
    {
        "id": 3,
        "user": "Jodi Humphrey",
        "text": "Oh please ur preaching to the choir"
    },
    {
        "id": 4,
        "user": "Joyce Weber",
        "text": "Enlarge your penis. x-to-xxx@email.me "
    },
    {
        "id": 5,
        "user": "Gilliam Underwood",
        "text": "If guns dont kill people, people kill people -- does that mean that toasters dont toast toast, toast toast toast?"
    },
    {
        "id": 6,
        "user": "Dolly Franklin",
        "text": "Don’t talk out loud. You lower the IQ of the whole street."
    },
    {
        "id": 7,
        "user": "Brennan Atkins",
    ...
    },
    {
        "id": 9,
        "user": "Joyce Weber",
        "text": "I can speak Latin, but I never do."
    }
